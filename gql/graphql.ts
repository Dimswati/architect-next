...
/** Allowed Content Types of the Group taxonomy. */
export enum ContentTypesOfGroupEnum {
  /** The Type of Content object */
  Projects = 'PROJECTS'
}
...
export type CreateGroupInput = {
  /** The slug that the group will be an alias of */
  aliasOf: InputMaybe<Scalars['String']['input']>;
  /** This is an ID that can be passed to a mutation by the client to track the progress of mutations and catch possible duplicate mutation submissions. */
  clientMutationId: InputMaybe<Scalars['String']['input']>;
  /** The description of the group object */
  description: InputMaybe<Scalars['String']['input']>;
  /** The name of the group object to mutate */
  name: Scalars['String']['input'];
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
  slug: InputMaybe<Scalars['String']['input']>;
};
...
export type CreateProjectInput = {
  ...
  /** The date of the object. Preferable to enter as year/month/day (e.g. 01/31/2017) as it will rearrange date as fit if it is not specified. Incomplete dates may have unintended results for example, "2017" as the input will use current date with timestamp 20:17  */
  date: InputMaybe<Scalars['String']['input']>;
  /** Set connections between the Project and Groups */
  groups: InputMaybe<ProjectGroupsInput>;
  /** A field used for ordering posts. This is typically used with nav menu items or for special ordering of hierarchical content types. */
  menuOrder: InputMaybe<Scalars['Int']['input']>;
  /** The password used to protect the content of the object */
  password: InputMaybe<Scalars['String']['input']>;
...
/** The Group type */
export type Group = DatabaseIdentifier & MenuItemLinkable & Node & TermNode & UniformResourceIdentifiable & {
  __typename?: 'Group';
  /** Connection between the Group type and the ContentNode type */
  contentNodes: Maybe<GroupToContentNodeConnection>;
  /** The number of objects connected to the object */
  count: Maybe<Scalars['Int']['output']>;
  /** The unique identifier stored in the database */
  databaseId: Scalars['Int']['output'];
  ...
  /** The human friendly name of the object. */
  name: Maybe<Scalars['String']['output']>;
  /** Connection between the Group type and the Project type */
  projects: Maybe<GroupToProjectConnection>;
  /** An alphanumeric identifier for the object unique to its type. */
  slug: Maybe<Scalars['String']['output']>;
  /** Connection between the Group type and the Taxonomy type */
  taxonomy: Maybe<GroupToTaxonomyConnectionEdge>;
  /** The name of the taxonomy that the object is associated with */
  taxonomyName: Maybe<Scalars['String']['output']>;
  /** The ID of the term group that this term object belongs to */
  termGroupId: Maybe<Scalars['Int']['output']>;
...
/** The Group type */
export type GroupContentNodesArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<GroupToContentNodeConnectionWhereArgs>;
};
...
export type GroupProjectsArgs = {
  ...
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<GroupToProjectConnectionWhereArgs>;
};

/** Connection to Group Nodes */
export type GroupConnection = {
  /** A list of edges (relational context) between RootQuery and connected Group Nodes */
  edges: Array<GroupConnectionEdge>;
  /** A list of connected Group Nodes */
  nodes: Array<Group>;
  /** Information about pagination in a connection. */
  pageInfo: GroupConnectionPageInfo;
};

/** Edge between a Node and a connected Group */
export type GroupConnectionEdge = {
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The connected Group Node */
  node: Group;
};

/** Page Info on the connected GroupConnectionEdge */
export type GroupConnectionPageInfo = {
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Connection between the Group type and the ContentNode type */
export type GroupToContentNodeConnection = Connection & ContentNodeConnection & {
  __typename?: 'GroupToContentNodeConnection';
  /** Edges for the GroupToContentNodeConnection connection */
  edges: Array<GroupToContentNodeConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<ContentNode>;
  /** Information about pagination in a connection. */
  pageInfo: GroupToContentNodeConnectionPageInfo;
};

/** An edge in a connection */
export type GroupToContentNodeConnectionEdge = ContentNodeConnectionEdge & Edge & {
  __typename?: 'GroupToContentNodeConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: ContentNode;
...
/** Page Info on the &quot;GroupToContentNodeConnection&quot; */
export type GroupToContentNodeConnectionPageInfo = ContentNodeConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'GroupToContentNodeConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the GroupToContentNodeConnection connection */
export type GroupToContentNodeConnectionWhereArgs = {
  /** The Types of content to filter */
  contentTypes: InputMaybe<Array<InputMaybe<ContentTypesOfGroupEnum>>>;
  /** Filter the connection based on dates */
  dateQuery: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Group type and the Project type */
export type GroupToProjectConnection = Connection & ProjectConnection & {
  __typename?: 'GroupToProjectConnection';
  /** Edges for the GroupToProjectConnection connection */
  edges: Array<GroupToProjectConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Project>;
  /** Information about pagination in a connection. */
  pageInfo: GroupToProjectConnectionPageInfo;
};

/** An edge in a connection */
export type GroupToProjectConnectionEdge = Edge & ProjectConnectionEdge & {
  __typename?: 'GroupToProjectConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Project;
...
/** Page Info on the &quot;GroupToProjectConnection&quot; */
export type GroupToProjectConnectionPageInfo = PageInfo & ProjectConnectionPageInfo & WpPageInfo & {
  __typename?: 'GroupToProjectConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the GroupToProjectConnection connection */
export type GroupToProjectConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword: InputMaybe<Scalars['Boolean']['input']>;
...
/** Connection between the Group type and the Taxonomy type */
export type GroupToTaxonomyConnectionEdge = Edge & OneToOneConnection & TaxonomyConnectionEdge & {
  __typename?: 'GroupToTaxonomyConnectionEdge';
  /** Opaque reference to the nodes position in the connection. Value can be used with pagination args. */
  cursor: Maybe<Scalars['String']['output']>;
  /** The node of the connection, without the edges */
  node: Taxonomy;
...
/** The Member type */
export type Member = ContentNode & DatabaseIdentifier & HierarchicalContentNode & HierarchicalNode & MenuItemLinkable & Node & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Member';
  /** Returns ancestors of the node. Default ordered as lowest (closest to the child) to highest (closest to the root). */
  ancestors: Maybe<HierarchicalContentNodeToContentNodeAncestorsConnection>;
  /** Connection between the HierarchicalContentNode type and the ContentNode type */
  ...
  /** Connection between the Member type and the Member type */
  revisions: Maybe<MemberToRevisionConnection>;
  /** The uri slug for the post. This is equivalent to the WP_Post-&gt;post_name field and the post_name column in the database for the &quot;post_objects&quot; table. */
  slug: Maybe<Scalars['String']['output']>;
  /** The current status of the object */
  status: Maybe<Scalars['String']['output']>;
...
/** The Member type */
export type MemberChildrenArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
...
/** The Member type */
export type MemberRevisionsArgs = {
  after: InputMaybe<Scalars['String']['input']>;
  before: InputMaybe<Scalars['String']['input']>;
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<MemberToRevisionConnectionWhereArgs>;
};
...
/** Connection between the Member type and the Member type */
export type MemberToRevisionConnection = Connection & MemberConnection & {
  __typename?: 'MemberToRevisionConnection';
  /** Edges for the MemberToRevisionConnection connection */
  edges: Array<MemberToRevisionConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Member>;
  /** Information about pagination in a connection. */
  pageInfo: MemberToRevisionConnectionPageInfo;
};

/** An edge in a connection */
export type MemberToRevisionConnectionEdge = Edge & MemberConnectionEdge & {
  __typename?: 'MemberToRevisionConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Member;
...
/** Page Info on the &quot;MemberToRevisionConnection&quot; */
export type MemberToRevisionConnectionPageInfo = MemberConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'MemberToRevisionConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the MemberToRevisionConnection connection */
export type MemberToRevisionConnectionWhereArgs = {
  /** Filter the connection based on dates */
  dateQuery: InputMaybe<DateQueryInput>;
  /** True for objects with passwords; False for objects without passwords; null for all objects with or without passwords */
  hasPassword: InputMaybe<Scalars['Boolean']['input']>;
...
export type MenuItemObjectUnion = Category | Group | Member | Page | Post | Project | Service | Tag;
...
export type Project = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithFeaturedImage & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  ...
  /** Globally unique ID of the featured image assigned to the node */
  featuredImageId: Maybe<Scalars['ID']['output']>;
  /** Connection between the Project type and the Group type */
  groups: Maybe<ProjectToGroupConnection>;
  /** The global unique identifier for this post. This currently matches the value stored in WP_Post-&gt;guid and the guid column in the &quot;post_objects&quot; database table. */
  guid: Maybe<Scalars['String']['output']>;
...
export type ProjectGroupsArgs = {
  ...
  first: InputMaybe<Scalars['Int']['input']>;
  last: InputMaybe<Scalars['Int']['input']>;
  where: InputMaybe<ProjectToGroupConnectionWhereArgs>;
};
...
/** Set relationships between the Project to Groups */
export type ProjectGroupsInput = {
  /** If true, this will append the Group to existing related Groups. If false, this will replace existing relationships. Default true. */
  append: InputMaybe<Scalars['Boolean']['input']>;
  /** The input list of items to set. */
  nodes: InputMaybe<Array<InputMaybe<ProjectGroupsNodeInput>>>;
};

/** List of Groups to connect the Project to. If an ID is set, it will be used to create the connection. If not, it will look for a slug. If neither are valid existing terms, and the site is configured to allow terms to be created during post mutations, a term will be created using the Name if it exists in the input, then fallback to the slug if it exists. */
export type ProjectGroupsNodeInput = {
  /** The description of the Group. This field is used to set a description of the Group if a new one is created during the mutation. */
  description: InputMaybe<Scalars['String']['input']>;
  /** The ID of the Group. If present, this will be used to connect to the Project. If no existing Group exists with this ID, no connection will be made. */
  id: InputMaybe<Scalars['ID']['input']>;
  /** The name of the Group. This field is used to create a new term, if term creation is enabled in nested mutations, and if one does not already exist with the provided slug or ID or if a slug or ID is not provided. If no name is included and a term is created, the creation will fallback to the slug field. */
  name: InputMaybe<Scalars['String']['input']>;
  /** The slug of the Group. If no ID is present, this field will be used to make a connection. If no existing term exists with this slug, this field will be used as a fallback to the Name field when creating a new term to connect to, if term creation is enabled as a nested mutation. */
  slug: InputMaybe<Scalars['String']['input']>;
};
...
/** Connection between the Project type and the Group type */
export type ProjectToGroupConnection = Connection & GroupConnection & {
  __typename?: 'ProjectToGroupConnection';
  /** Edges for the ProjectToGroupConnection connection */
  edges: Array<ProjectToGroupConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Group>;
  /** Information about pagination in a connection. */
  pageInfo: ProjectToGroupConnectionPageInfo;
};

/** An edge in a connection */
export type ProjectToGroupConnectionEdge = Edge & GroupConnectionEdge & {
  __typename?: 'ProjectToGroupConnectionEdge';
  /** A cursor for use in pagination */
  cursor: Maybe<Scalars['String']['output']>;
  /** The item at the end of the edge */
  node: Group;
...
/** Page Info on the &quot;ProjectToGroupConnection&quot; */
export type ProjectToGroupConnectionPageInfo = GroupConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'ProjectToGroupConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** Arguments for filtering the ProjectToGroupConnection connection */
export type ProjectToGroupConnectionWhereArgs = {
  /** Unique cache key to be produced when this query is stored in an object cache. Default is 'core'. */
  cacheDomain: InputMaybe<Scalars['String']['input']>;
  /** Term ID to retrieve child terms of. If multiple taxonomies are passed, $child_of is ignored. Default 0. */
  childOf: InputMaybe<Scalars['Int']['input']>;
...
/** Connection between the RootQuery type and the Group type */
export type RootQueryToGroupConnection = Connection & GroupConnection & {
  __typename?: 'RootQueryToGroupConnection';
  /** Edges for the RootQueryToGroupConnection connection */
  edges: Array<RootQueryToGroupConnectionEdge>;
  /** The nodes of the connection, without the edges */
  nodes: Array<Group>;
  /** Information about pagination in a connection. */
  pageInfo: RootQueryToGroupConnectionPageInfo;
};

/** An edge in a connection */
export type RootQueryToGroupConnectionEdge = Edge & GroupConnectionEdge & {
...
/** Page Info on the &quot;RootQueryToGroupConnection&quot; */
export type RootQueryToGroupConnectionPageInfo = GroupConnectionPageInfo & PageInfo & WpPageInfo & {
  __typename?: 'RootQueryToGroupConnectionPageInfo';
  /** When paginating forwards, the cursor to continue. */
  endCursor: Maybe<Scalars['String']['output']>;
  /** When paginating forwards, are there more items? */
  hasNextPage: Scalars['Boolean']['output'];
...
/** The Service type */
export type Service = ContentNode & DatabaseIdentifier & MenuItemLinkable & Node & NodeWithContentEditor & NodeWithFeaturedImage & NodeWithRevisions & NodeWithTemplate & NodeWithTitle & Previewable & UniformResourceIdentifiable & {
  __typename?: 'Service';
  /** The content of the post. */
  content: Maybe<Scalars['String']['output']>;
  /** Connection between the ContentNode type and the ContentType type */
...
export type Service_Servicefields = AcfFieldGroup & {
  ...
  /** The name of the ACF Field Group */
  fieldGroupName: Maybe<Scalars['String']['output']>;
  projectsDone: Maybe<Scalars['Float']['output']>;
};
...
export type UpdateGroupInput = {
  ...
  /** The description of the group object */
  description: InputMaybe<Scalars['String']['input']>;
  /** The ID of the Group object to update */
  id: Scalars['ID']['input'];
  /** The name of the group object to mutate */
  name: InputMaybe<Scalars['String']['input']>;
  /** If this argument exists then the slug will be checked to see if it is not an existing valid term. If that check succeeds (it is not a valid term), then it is added and the term id is given. If it fails, then a check is made to whether the taxonomy is hierarchical and the parent argument is not empty. If the second check succeeds, the term will be inserted and the term id will be given. If the slug argument is empty, then it will be calculated from the term name. */
...
export type GroupListQuery = { __typename?: 'RootQuery', groups: { __typename?: 'RootQueryToGroupConnection', edges: Array<{ __typename?: 'RootQueryToGroupConnectionEdge', node: { __typename?: 'Group', databaseId: number, name: string | null, slug: string | null } }> } | null };

export type ProjectListQueryVariables = Exact<{ [key: string]: never; }>;


export type ProjectListQuery = { __typename?: 'RootQuery', projects: { __typename?: 'RootQueryToProjectConnection', edges: Array<{ __typename?: 'RootQueryToProjectConnectionEdge', node: { __typename?: 'Project', databaseId: number, slug: string | null, title: string | null, date: string | null, groups: { __typename?: 'ProjectToGroupConnection', nodes: Array<{ __typename?: 'Group', name: string | null, slug: string | null }> } | null, projectFields: { __typename?: 'Project_Projectfields', rating: number | null, client: string | null } | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl: string | null } } | null } }> } | null };

export type ProjectFragment = { __typename?: 'Project', databaseId: number, slug: string | null, title: string | null, date: string | null, groups: { __typename?: 'ProjectToGroupConnection', nodes: Array<{ __typename?: 'Group', name: string | null, slug: string | null }> } | null, projectFields: { __typename?: 'Project_Projectfields', rating: number | null, client: string | null } | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl: string | null } } | null };

export type ServiceListQueryVariables = Exact<{ [key: string]: never; }>;


export type ServiceListQuery = { __typename?: 'RootQuery', services: { __typename?: 'RootQueryToServiceConnection', edges: Array<{ __typename?: 'RootQueryToServiceConnectionEdge', node: { __typename?: 'Service', databaseId: number, title: string | null, slug: string | null, content: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl: string | null } } | null, serviceFields: { __typename?: 'Service_Servicefields', projectsDone: number | null } | null } }> } | null };

export type SingleServiceQueryVariables = Exact<{
  slug: Scalars['ID']['input'];
}>;


export type SingleServiceQuery = { __typename?: 'RootQuery', service: { __typename?: 'Service', databaseId: number, title: string | null, slug: string | null, content: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl: string | null } } | null, serviceFields: { __typename?: 'Service_Servicefields', projectsDone: number | null } | null } | null };

export type ServiceFragment = { __typename?: 'Service', databaseId: number, title: string | null, slug: string | null, content: string | null, featuredImage: { __typename?: 'NodeWithFeaturedImageToMediaItemConnectionEdge', node: { __typename?: 'MediaItem', sourceUrl: string | null } } | null, serviceFields: { __typename?: 'Service_Servicefields', projectsDone: number | null } | null };
...
export const ProjectFragmentDoc = new TypedDocumentString(`
  ...
  featuredImage {
    ...
    `, {"fragmentName":"Project"}) as unknown as TypedDocumentString<ProjectFragment, unknown>;
...
export const GroupListDocument = new TypedDocumentString(`
    query GroupList {
  groups {
    edges {
      node {
    ...
    `) as unknown as TypedDocumentString<GroupListQuery, GroupListQueryVariables>;
...
export const SingleServiceDocument = new TypedDocumentString(`
...
}`) as unknown as TypedDocumentString<SingleServiceQuery, SingleServiceQueryVariables>;